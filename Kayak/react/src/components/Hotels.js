...
class Hotels extends Component {
  ...
  handleFilter = () => {
    ...
    console.log(this.state.origHotelData);
                      ...
                      <div className="col-md-12 search-grid-right" data-toggle="collapse">
                        <div className="hotel-rooms">
                          ...
                          <div className="hotel-right text-right">
                            ...
                            <p>Best price</p>
                            <a
                              onClick={() => this.displayhotelbookingmodal(item.HID, item.rooms[0].RID, item.name, item.rooms[0].type, item.rooms[0].rent)}>Continue</a>
                          </div>
