              ...
              <div role="tabpanel" className="tab-pane active" id="flights">
                ...
                <div className="row">
                  ...
                  <div className="col-xs-2 mt"
                       style={{display: this.state.return_enable ? 'inline-block' : 'none', padding: 0}}>
                    <div className="input-field">
                  ...
                  <div className="col-xs-1" style={padding}>
                    <button className="btn btn-primary btn-block" style={{btnStyle, padding: 0, height: 40, width: 40, borderRadius: 0}} onClick={() => this.searchFlight()}>
            ...
            <div className="search-grids">
              <div className="col-md-3 search-grid-left" style={{marginTop: 25}}>
                ...
                <div className="range">
                  ...
                  <Range min={100} max={2000} defaultValue={[100, 2000]} tipFormatter={value => `${value}`}
