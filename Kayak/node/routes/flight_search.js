...
router.get('/search', function (req, res, next) {
    ...
    if(category==='e'){
        fetchDataSQL = "select f_id,sum(b.booked_seats_e) as seats from flight_booking b where b.flight_date_s = '"+date+"' and  b.f_id in (   select f_id from kayak.flight f    where f.from='"+from+"' and f.to='"+to+"' and f.day_no like concat('%','"+d.getUTCDay()+"','%') ) group by b.f_id";
    }else if(category==='f'){
        fetchDataSQL = "select f_id,sum(b.booked_seats_f) as seats from flight_booking b where b.flight_date_s = '"+date+"' and  b.f_id in (   select f_id from kayak.flight f    where f.from='"+from+"' and f.to='"+to+"' and f.day_no like concat('%','"+d.getUTCDay()+"','%') ) group by b.f_id";
    }else if(category==='b'){
        fetchDataSQL = "select f_id,sum(b.booked_seats_b) as seats from flight_booking b where b.flight_date_s = '"+date+"' and  b.f_id in (   select f_id from kayak.flight f    where f.from='"+from+"' and f.to='"+to+"' and f.day_no like concat('%','"+d.getUTCDay()+"','%') ) group by b.f_id";
    }
    ...
    mysql.fetchData(function(err,results){
        if(err){
            ...
            if(arrayOfFlights.length>0){
                if(category==='e'){
                    fetchDataSQL4 = "select f_id, airline_name, fare_e as fare, fare_child_e as fare_child, capacity_e as capacity, time_s, time_e from flight f where f.from='"+from+"' and f.to='"+to+"' and f.day_no like concat('%','"+d.getUTCDay()+"','%') and f_id not in ("+arrayOfFlights+")";
                }else if(category==='f'){
                    fetchDataSQL4 = "select f_id, airline_name, fare_f as fare, fare_child_f as fare_child, capacity_f as capacity, time_s, time_e from flight f where f.from='"+from+"' and f.to='"+to+"' and f.day_no like concat('%','"+d.getUTCDay()+"','%') and f_id not in ("+arrayOfFlights+")";
                }else if(category==='b'){
                    fetchDataSQL4 = "select f_id, airline_name, fare_b as fare, fare_child_b as fare_child, capacity_b as capacity, time_s, time_e from flight f where f.from='"+from+"' and f.to='"+to+"' and f.day_no like concat('%','"+d.getUTCDay()+"','%') and f_id not in ("+arrayOfFlights+")";
                }
            }else{
                if(category==='e'){
                    fetchDataSQL4 = "select f_id, airline_name, fare_e as fare, fare_child_e as fare_child, capacity_e as capacity, time_s, time_e from flight f where f.from='"+from+"' and f.to='"+to+"' and f.day_no like concat('%','"+d.getUTCDay()+"','%')";
                }else if(category==='f'){
                    fetchDataSQL4 = "select f_id, airline_name, fare_f as fare, fare_child_f as fare_child, capacity_f as capacity, time_s, time_e from flight f where f.from='"+from+"' and f.to='"+to+"' and f.day_no like concat('%','"+d.getUTCDay()+"','%')";
                }else if(category==='b'){
                    fetchDataSQL4 = "select f_id, airline_name, fare_b as fare, fare_child_b as fare_child, capacity_b as capacity, time_s, time_e from flight f where f.from='"+from+"' and f.to='"+to+"' and f.day_no like concat('%','"+d.getUTCDay()+"','%')";
                }
            }
...
router.get('/flight_booking_direct', function (req, res, next) {
    ...
    fetchDataSQL = "SELECT IFNULL((SELECT MAX(booking_id) + 1  FROM flight_booking), 1) AS max;";
